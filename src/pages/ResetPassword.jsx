              ...
              <div className="grid grid-cols-1 gap-4">
                <div className="rounded-lg overflow-hidden shadow-lg">
                  ...
                  <div className="p-3 bg-white/90 backdrop-blur-sm">
                    <span className="text-sm font-medium text-gray-700">Contraseña fuerte</span>
                  </div>
                </div>
                ...
                <div className="rounded-lg overflow-hidden shadow-lg">
                  ...
                  />
                  <div className="p-3 bg-white/90 backdrop-blur-sm">
                    <span className="text-sm font-medium text-gray-700">Protección</span>
                  </div>
                </div>
                ...
                <div className="rounded-lg overflow-hidden shadow-lg">
                  ...
                  />
                  <div className="p-3 bg-white/90 backdrop-blur-sm">
                    <span className="text-sm font-medium text-gray-700">Nueva clave</span>
                  </div>
                </div>
              </div>
            </div>
